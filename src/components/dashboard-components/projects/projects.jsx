...
const Projects = () => {
    ...
    return (
        ...
        <Card>
                ...
                <Button className="bg-white text-dark">See More Details</Button>
                        </CardBody>
                        ...
                        <Button className="bg-white text-dark">See More Reviews</Button>
                    </CardFooter>
            </Card>
